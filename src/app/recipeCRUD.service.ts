...
export class RecipeCRUDService {
    ...
    getSalads(): Observable<Recipe[]> {
        return this.http.get<Recipe[]>('http://localhost:3000/salads')
            .pipe(
                catchError(this.handleError)
            )
    }
    ...
    getGrainRecipes(): Observable<Recipe[]> {
        return this.http.get<Recipe[]>('http://localhost:3000/grain-recipes')
            .pipe(
                catchError(this.handleError)
            )
    }
    ...
    deleteRecipe(recipe_ID: number, recipe: Recipe) {
        return this.http.put(`http://localhost:3000/delete-recipe/${recipe_ID}`, recipe)
            .pipe(
                catchError(this.handleError)
            );
    }
